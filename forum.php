...
?>
<style>
#portfolio .img-fluid{      /* Style for images inside portfolio section */
    width: calc(100%);
    height: 30vh;
    z-index: -1;
    position: relative;
...
.gallery-list{      /* Styling for clickable gallery card */
cursor: pointer;
border: unset;
flex-direction: inherit;
}
.gallery-img,.gallery-list .card-body {     /* Half-width for image and text inside gallery */
    width: calc(50%)
}
.gallery-img img{       /* Style for gallery images */
    border-radius: 5px;
    min-height: 50vh;
    max-width: calc(100%);
}
span.hightlight{        /* Highlight class for yellow background */
    background: yellow;
}
.carousel,.carousel-inner,.carousel-item{   /* Carousel full height */
   min-height: calc(100%)
}
header.masthead,header.masthead:before {    /* Masthead (header) section height */
        min-height: 50vh !important;
        height: 50vh !important
    }
.row-items{     /* Positioning row items */
    position: relative;
}
.masthead{
